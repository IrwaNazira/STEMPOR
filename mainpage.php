...
$schoolemail = $_GET['schoolemail']; 
    ...
    try {
        ...
        echo "<p><h1 align='center'>STEM information</h1></p>";
        echo "<table border='1'>
        <tr>
          <th>Program Name</th>
          <th>Date</th>
        ...
        foreach($steminfo as $steminfo) {
            ...
            &options=del' onclick= 'return confirm(\"Delete. Are your sure?\");'><i class='fa fa-trash' style='font-size:15px'></i></a><br>
            ...
            &date=".$steminfo['date']."&company=".$steminfo['company']."&companyname=".$steminfo['companyname']."'><i class='fa fa-edit' style='font-size:15px'></i></td>";
            echo "</tr>";
        } 
        echo "</table>";
